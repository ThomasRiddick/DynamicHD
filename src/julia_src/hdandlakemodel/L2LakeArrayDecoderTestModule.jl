...
@testset "Lake Array Decoder tests" begin
  #One lake
  array_in::Vector{Float64} = vec(Float64[#=
  ...
  @test lake_parameters[1].lake_lower_boundary_height == 5.0
  @test lake_parameters[1].filled_lake_area == 11.0
  #Two lakes that join
  array_in = Float64[#=
  ...
  @test lake_parameters[1].lake_lower_boundary_height == 5.0
  @test lake_parameters[1].filled_lake_area == 2.0
  ...
  @test lake_parameters[2].lake_lower_boundary_height == 5.0
  @test lake_parameters[2].filled_lake_area == 3.0
  ...
  @test lake_parameters[3].lake_lower_boundary_height == 8.0
  @test lake_parameters[3].filled_lake_area == 6.0
end
