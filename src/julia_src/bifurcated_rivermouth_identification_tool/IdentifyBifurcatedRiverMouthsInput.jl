...
function load_icosahedral_field(file_handle,var_name,ndims,field_type)
...
function load_icosahedral_grid(grid_filepath)
  ...
  cell_indices_int::Array{Int64} = load_icosahedral_field(file_handle,"",1,Int64)
  cell_neighbors_int::Array{Int64} = load_icosahedral_field(file_handle,"",2,Int64)
  lats::Array{Float64} = load_icosahedral_field(file_handle,"",1,Float64)
  lons::Array{Float64} = load_icosahedral_field(file_handle,"",1,Float64)
  lat_vertices::Array{Float64} = load_icosahedral_field(file_handle,"",2,Float64)
  lon_vertices::Array{Float64} = load_icosahedral_field(file_handle,"",2,Float64)
...
function load_landsea_mask(lsmask_filepath)
  println("Loading: " * lsmask_filepath)
  file_handle::NcFile = NetCDF.open(lsmask_filepath)
  lsmask_int::Array{Int64} = load_icosahedral_field(file_handle,"",1,Int64)
