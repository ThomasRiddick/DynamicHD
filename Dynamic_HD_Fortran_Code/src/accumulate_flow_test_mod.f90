    ...
    subroutine testCalculateCumlativeFlow
      ...
      integer :: i
        ...
        call accumulate_flow_icon_single_index(cell_neighbors, &
            ...
            write(*,"(15(XI2X))") (output_cumulative_flow(i), i=6,20)
            write(*,"(20(XI2))") (output_cumulative_flow(i), i=21,40)
            write(*,"(20(XI2))") (output_cumulative_flow(i), i=41,60)
            write(*,"(15(XI2X))") (output_cumulative_flow(i), i=61,75)
