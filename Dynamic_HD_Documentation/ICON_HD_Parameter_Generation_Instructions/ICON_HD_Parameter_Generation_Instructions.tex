...
Land-sea Mask Downscaling Alg. & Recreates the outline of a course land-sea mask in a finer grid. Cross grid downscaling from an ICON grid to a finer latitude-longitude grid is possible.\\
...
\item Start parameters for high resolutions
