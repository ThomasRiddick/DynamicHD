...
class Dynamic_Lake_Production_Run_Drivers(dyn_hd_dr.Dynamic_HD_Drivers):
    ...
    def __init__(self,input_orography_filepath=None,input_ls_mask_filepath=None,
                 ...
                 current_date=None,
                 additional_orography_corrections_list_filepath=None):
        """Class constructor.
        ...
        self.additional_orography_corrections_list_filename = \
             additional_orography_corrections_list_filepath
...
def parse_arguments():
    ...
    parser.add_argument('-d','--current-date',
                        ...
                        type=str,
                        default=None)
    parser.add_argument('-a','--additional-orography-corrections-list-filepath',
