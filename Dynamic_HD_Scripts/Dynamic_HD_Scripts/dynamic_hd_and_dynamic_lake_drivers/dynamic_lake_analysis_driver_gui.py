##############################################
#OBSOLETE Replaced with new GUI using tkinter#
##############################################
...
#                   self.get_filepath("base_date_based_corrections_filepath"),
#                   self.get_filepath("base_additional_corrections_filepath"),
...
#                   [sg.Text("For clear lake and river result -2 is off, -1 is all, 0+ is version num")],
#                   self.get_integer("clear_lake_results",-2),
#                   self.get_integer("clear_river_results",-2),
