...
cdef extern from 'drivers/compute_catchments_icon_interface.cpp':
...
def compute_catchments_icon_cpp(np.ndarray[int,ndim=1,mode='c'] next_cell_index_in,
    ...
    compute_catchments_icon_cython_interface(ncells,
