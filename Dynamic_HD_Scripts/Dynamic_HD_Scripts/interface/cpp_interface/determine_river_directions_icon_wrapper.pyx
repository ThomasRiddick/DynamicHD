...
def determine_river_directions_icon_si_cpp(np.ndarray[double,ndim=1,mode='c'] orography_in,
                                           ...
                                           bint always_flow_to_sea_in,
                                           bint mark_pits_as_true_sinks_in):
    cdef int ncells
    ncells = len(orography_in)
    determine_river_directions_icon_si_cython_interface(ncells,
                                                        &orography_in[0],
                                                        &landsea_in_int[0],
                                                        &landsea_in_double[0],
                                                        &true_sinks_in_int[0],
