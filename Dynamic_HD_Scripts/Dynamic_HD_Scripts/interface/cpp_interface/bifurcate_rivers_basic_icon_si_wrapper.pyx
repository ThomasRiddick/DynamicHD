...
cdef extern from 'drivers/bifurcate_rivers_basic_icon_simple_interface.cpp':
...
def bifurcate_rivers_basic_icon_si_cpp(np.ndarray[int,ndim=1,mode='c'] neighboring_cell_indices_in,
    ...
    bifurcate_rivers_basic_icon_si_cython_interface(ncells,
