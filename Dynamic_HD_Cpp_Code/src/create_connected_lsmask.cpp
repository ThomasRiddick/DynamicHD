...
void create_connected_lsmask_cython_wrapper(int* landsea_in_int, int* ls_seed_points_in_int,
  	  	  	  	  	  	  	  	  	  	  	int nlat_in, int nlon_in, int use_diagonals_in_int)
{
	...
	create_connected_lsmask_main(landsea_in, ls_seed_points_in,
...
void create_connected_lsmask_main(bool* landsea_in, bool* ls_seed_points_in,
		  	  	  	  	  	  	  int nlat_in, int nlon_in, bool use_diagonals_in)
{
	auto alg = create_connected_landsea_mask();
	alg.setup_flags(use_diagonals_in);
	alg.setup_fields(landsea_in, ls_seed_points_in, nlat_in, nlon_in);
