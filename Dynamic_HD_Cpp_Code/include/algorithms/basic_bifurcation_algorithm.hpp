...
class basic_bifurcation_algorithm {
  public:
    basic_bifurcation_algorithm() {};
...
class basic_bifurcation_algorithm_latlon : public basic_bifurcation_algorithm {
  public:
    basic_bifurcation_algorithm_latlon() {};
...
class basic_bifurcation_algorithm_icon_single_index : public basic_bifurcation_algorithm {
  public:
