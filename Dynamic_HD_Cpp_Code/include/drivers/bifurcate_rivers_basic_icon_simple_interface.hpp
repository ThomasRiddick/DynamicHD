#ifndef INCLUDE_BIFURCATE_RIVERS_BASIC_ICON_SI_WRAPPER_HPP_
#define INCLUDE_BIFURCATE_RIVERS_BASIC_ICON_SI_WRAPPER_HPP_
...
#endif /* INCLUDE_BIFURCATE_RIVERS_BASIC_ICON_SI_WRAPPER_HPP_ */
